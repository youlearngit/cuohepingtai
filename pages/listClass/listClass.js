...
Page({
    ...
    data: {
      ...
      showInvestmentIndustry:false,
      showInvestmentArea:false,
      theme: 'light',
    ...
    chooseInvestmentIndustry(){
      this.setData({
        showInvestmentIndustry:true
      })
    },
    ...
    chooseIndustry(e){
     this.setData({
      isSelectIndustry:e.currentTarget.dataset.index
     })
    },
    Fbundselect(e) {
      console.log(e)
    ...
    chooseInvestmentArea(){
     this.setData({
       showInvestmentArea:true
     })
    },
    chooseAddress(e){
     console.log(e)
